...
const HowItWorks = () => {
  return (
    ...
    <div className='c1 mr-[15vw] mt-10 flex justify-center  items-center gap-7 rounded-3xl p-4 bg-[#ddecfb] shadow-lg shadow-lg  m-4 md:w-[40vw]'>
      <div>
    ...
    <div className='c2 mt-10 ml-[15vw] flex justify-center items-center gap-7 rounded-3xl p-4 bg-[#ddecfb] shadow-lg md:w-[40vw]  m-4'>
      <div>
    ...
    <div className='c3 mr-[15vw] mt-10 flex justify-center items-center gap-7 rounded-3xl p-4 bg-[#ddecfb] shadow-lg md:w-[40vw] m-4'>
      <div>
